...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            dbc.Row([
                dbc.Col(dbc.Label("Adiposity:"), width=6),
                dbc.Col(dbc.Input(id='input-adiposity', type='number', value=25, min=18.0), width=6),
            ], className="mb-3"),
...
@app.callback(
    ...
    [
        ...
        State("input-adiposity", "value"),  # corrected from "adiposity-input"
